...
<template>
  <div class="min-h-screen bg-gray-100">
    <aside
      :class="[
        'w-[250px] bg-white h-screen fixed top-0 -left-full p-4 flex flex-col justify-between lg:left-0 z-10 transition-all border-r border-gray-200 lg:border-r-0',
